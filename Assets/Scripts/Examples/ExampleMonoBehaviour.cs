...
{
    [DocGen("DocGen adds a <b>DocGen</b> attribute that allows more documentation text to be added to an attribute. This text will be displayed in the inspector via a PropertyDrawer as well as in the generated documentation.")]
    public class ExampleMonoBehaviour : MonoBehaviour
    {
        [Tooltip("This is a public string field with a tooltip (you are reading it now).")]
        [DocGen("Using the <b>DocGen</b> attribute you can add additional documentation to a field that doesn't fit into a ToolTip. This content will only be visible if the field is expanded. The content will also appear in the generated documentation. ")]
